package com.example.mypc.camerasurfaceview.helpers;
...
public class NotificationHelper {
    ...
    public void createTrainingStatusNotification() {
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(mContext.get());
        mBuilder.setSmallIcon(android.R.drawable.progress_horizontal);
        mBuilder.setContentTitle(mContext.get().getString(R.string.notification_training_progress));
    ...
    public void createTrainingFailNotification() {
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(mContext.get());
        mBuilder.setSmallIcon(android.R.drawable.ic_dialog_alert);
        mBuilder.setContentTitle("Training Person Group Failed !");
